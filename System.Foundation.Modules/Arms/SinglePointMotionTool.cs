...
{
    [DisplayName("单点运动模块")]
    public class SinglePointMotionTool : ModuleToolBase
    {
        public SinglePointMotionData singlePointMotionData = new SinglePointMotionData();

        public class SinglePointMotionData: ModuleData
        {
            [DisplayName("坐标起始地址")]
        ...
        public override string DefineName => "单点运动模块";
        ...
        {
            var position = (QPosition)pinData;
            ...
            singlePointMotionData = Context<SinglePointMotionData>();
            float[] data;
