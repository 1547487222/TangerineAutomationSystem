...
{
    public abstract class  DynamicSyncInputPinTool:SyncInputToolBase
    {
        ...
        public override void ApplyOnContextChanged(object context)
        {
            ...
            if (dynamicPinData != null)
            {
                ...
                if (dynamicPinData.IsUpdateInput || ToolExecutionContext.Tool.ToolExecuter?.IsRunning == false)
                {
                    ToolExecutionContext.DestroySyncCache();
                    ToolExecutionContext.InitSyncCache();
